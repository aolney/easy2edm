...
\tocless\subsection{Deep Down, Everyone Wants to be Causal}\label{deep-down-everyone-wants-to-be-causal-jennifer-hill}}
\vspace{-6pt}
%\hspace{8pt}
\emph{Jennifer Hill, Professor of Applied Statistics at New York University, USA}
\vspace{8pt}\par
%\emph{Abstract:}
Most researchers in the social, behavioral, and health
...
\tocless\subsection{Beyond Algorithmic Fairness in Education: Equitable and
Inclusive Decision-Support Systems}\label{beyond-algorithmic-fairness-in-education-equitable-and-inclusive-decision-support-systems-renuxe9-kizilcec}}
\vspace{-6pt}
%\hspace{8pt}
\emph{René Kizilcec, Assistant Professor of Information Science at Cornell University, USA}
\vspace{8pt}\par
%\emph{Abstract:}
Advancing equity and inclusion in schools and
...
\tocless\subsection{No data about me without me: Including Learners and
Teachers in Educational Data Mining}\label{no-data-about-me-without-me-including-learners-and-teachers-in-educational-data-mining-judy-robertson}} %Judy Robertson
\vspace{-6pt}
%\hspace{8pt}
\emph{Judy Robertson, Professor of Digital Learning at the University of Edinburgh,
Scotland}
\vspace{8pt}\par
%\emph{Abstract:} 
The conference theme this year emphasizes the
...
\tocless\subsection{Test of Time Award: \\Compassionate, Data-Driven Tutors for
Problem Solving and Persistence}\label{test-of-time-award-compassionate-data-driven-tutors-for-problem-solving-and-persistence-tiffany-barnes}}
\vspace{-6pt}
%\hspace{8pt}
\emph{Tiffany Barnes, Distinguished Professor of Computer Science at North Carolina State University, USA}
\vspace{8pt}\par
%\emph{Abstract:}
Determining how, when, and whether to provide
...
\tocless\subsection{Empirical Evaluation of Deep Learning Models for
...
%\midrule
\endhead
\emph{Sami Sarsa} & Aalto University, Finland\\
\emph{Juho Leinonene} & Aalto University, Finland \\
\emph{Arto Hellas} & Aalto University, Finland \\
%\bottomrule
\end{longtable}
\vspace{-1mm}\par
%\emph{Abstract:}
New knowledge tracing models are continuously being
...
Deep Knowledge Tracing (LSTM-DKT) variants, two Dynamic Key-Value
...
\tocless\subsection{Latent Skill Mining and Labeling from Courseware
...
%\midrule
\endhead
%Noboru Matsuda, Jesse Wood, Raj Shrivastava, Machi Shimmei, North Carolina State University, USANorth Carolina State University, USA
%Norman Bier
\emph{Noboru Matsuda} & North Carolina State University, USA\\
\emph{Jesse Wood} & North Carolina State University, USA \\
\emph{Raj Shrivastava} & North Carolina State University, USA \\
\emph{Machi Shimmei} & North Carolina State University, USA \\
\emph{Norman Bier} & Carnegie Mellon University, USA \\
%\bottomrule
\end{longtable}
\vspace{-1mm}\par
%\emph{Abstract:}
A model that maps the requisite skills, or knowledge
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This creates a blank page at the end
%\clearpage
%\thispagestyle{empty}
%\mbox{}
%--------------------------------------
